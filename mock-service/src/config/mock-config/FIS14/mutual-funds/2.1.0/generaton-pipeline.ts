...
export async function createMockResponseFIS14_210(
    ...
    const defaultPath = api_details.default.replace(/^FIS14\//, '');
    ...
    const requirements = await mockAction.meetRequirements(sessionData as any);
    ...
    return mockAction.generator(payload, sessionData as any);
}