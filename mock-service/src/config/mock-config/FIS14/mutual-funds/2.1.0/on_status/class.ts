...
import { on_statusDefaultGenerator } from "./generator";
...
export class MockOnStatusClass extends MockAction {
    ...
    get description(): string {
        return "Mock for mutual funds on_status - form status updates";
    }

    async generator(existingPayload: any, sessionData: any): Promise<any> {
        return on_statusDefaultGenerator(existingPayload, sessionData);
    }
