# ONDC:RET15 — version 1.2.0

**Branch:** `draft-RET15-1.2.0`  
**Use Cases:** APPLIANCES
...
| `info.domain` | string | ONDC domain identifier (e.g. `ONDC:RET15`) |
| `info.description` | string? | Domain description |
| `info.version` | string | Spec version (e.g. `1.2.0`) |
