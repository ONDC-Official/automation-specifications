# ONDC:FIS10 — version 2.1.0

**Branch:** `draft-FIS10-GIFTCARD-2.1.0`  
**Use Cases:** gift-card
...
| `info.domain` | string | ONDC domain identifier (e.g. `ONDC:FIS10`) |
| `info.description` | string? | Domain description |
| `info.version` | string | Spec version (e.g. `2.1.0`) |
